...
describe('Test suits for <ProfessionalInfo />', () => {
    ...
    const store = mockStore({
        ...
        signUp: { emailId: 'Test@gmail.com', signUpDetails: { id: '1' } },
    ...
    beforeEach(() => {
        shallowWrapper = shallow(<GovtBusinessInfo
    ...
    it('should load the GovtBusiness component', () => {
        expect(wrapper).to.exist;
        expect(wrapper).to.have.length(1);
    });

    it('should load the GovtBusiness component with default values', () => {
